...
import me.conclure.clonomy.model.generic.Cleaner;
import me.conclure.clonomy.model.generic.IdentifierMapper;
import me.conclure.clonomy.model.generic.storage.AsyncPersistenceStorage;
...
public class UserManagerInterfaceImpl implements UserManagerInterface {
    ...
    @Override
    public Nil<UserDataTransfer> getIfCached(UUID id) {
    ...
    @Override
    public UserDataTransfer loadAndGet(UUID id) {
        return null;
    }

    @Override
    public UserDataTransfer saveAndGet(UUID id) {
        return null;
    }

    @Override
    public CompletableFuture<UserDataTransfer> loadAndGetAsync(UUID id) {
        return null;
    }

    @Override
    public CompletableFuture<UserDataTransfer> saveAndGetAsync(UUID id) {
        return null;
    }
    ...
    @Override
    public UserDataTransfer loadIfOfflineAndGet(UUID id) {
        return null;
    }

    @Override
    public CompletableFuture<UserDataTransfer> loadIfOfflineAndGetAsync(UUID id) {
        return null;
    }
